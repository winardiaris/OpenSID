...
<button type="button" title="Hapus Data" onclick="deleteAllBox('mainform','<?php echo site_url("lapor/delete_all/$p/$o")?>')" class="uibutton tipsy south"><span class="fa fa-trash-o fa-lg">&nbsp;</span>Hapus Data
</div>
</div>
</div>
...
<a href="<?php echo site_url("lapor/delete/$p/$o/$data[id]")?>" class="uibutton tipsy south" title="Hapus Data" target="confirm" message="Apakah Anda Yakin?" header="Hapus Data"><span class="fa fa-trash-o fa-lg"> Hapus</span></a><?php if($data['enabled'] == '2'):?><a href="<?php echo site_url('lapor/komentar_lock/'.$data['id'])?>" class="uibutton tipsy south" title="Verivikasi Laporan"><span class="icon-check icon-large"></span></a><?php elseif($data['enabled'] == '1'): ?><a href="<?php echo site_url('lapor/komentar_unlock/'.$data['id'])?>" class="uibutton tipsy south" title="Sanggah laporan"><span class="icon-unlock icon-large"></span></a>
<?php endif?></div>
</td>
