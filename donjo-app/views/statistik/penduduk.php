...
<div id="contentpane" style="overflow:auto;">
    ...
    <div class="ui-layout-north panel top">
        <div class="left">
			...
			<a href="<?php echo site_url("statistik/cetak/$lap")?>" class="uibutton tipsy south" title="Cetak Data" target="_blank"><span class="fa fa-print fa-lg">&nbsp;</span>Cetak Data</a>
			<a href="<?php echo site_url("statistik/excel/$lap")?>" class="uibutton tipsy south" title="Data Excel" target="_blank"><span class="fa fa-file-text fa-lg">&nbsp;</span>Data Excel</a>
