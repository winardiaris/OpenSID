    ...
    <div class="ui-layout-north panel">
        <div class="left">
            <div class="uibutton-group">
                ...
                <button type="button" title="Hapus Data" onclick="deleteAllBox('mainform','<?php echo site_url("sms/delete_all/$p/$o/2")?>')" class="uibutton tipsy south"><span class="fa fa-trash-o fa-lg">&nbsp;</span>Hapus Data
            </div>
        </div>
    </div>
