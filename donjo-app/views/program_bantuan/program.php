								...
								<tr>
									...
									<td style="width:120px;">
										<div class="uibutton-group">
											<a class="uibutton tipsy south" href="<?php echo site_url('program_bantuan/detail/'.$item["id"].'/'); ?>" title="Detail"><span class="fa fa-list fa-lg"></span> Detail</a>
											...
											<a class="uibutton tipsy south" href="<?php echo site_url('program_bantuan/hapus/'.$item["id"].'/'); ?>" title="Hapus Data" target="confirm" message="Apakah Anda Yakin?" header="Hapus Data"><span class="fa fa-trash-o fa-lg"></span></a>
										</div>
									</td>
