...
<div id="contentpane">
    ...
    <div class="ui-layout-north panel top">
        <div class="left">
			...
			<a href="<?php echo site_url("laporan_rentan/cetak")?>" class="uibutton tipsy south" title="Cetak" target="_blank"><span class="fa fa-print fa-lg">&nbsp;</span>Cetak</a>
	<a href="<?php echo site_url("laporan_rentan/excel")?>" class="uibutton tipsy south" title="Excel" target="_blank"><span class="fa fa-file-text fa-lg">&nbsp;</span>Excel</a>
            </div>
        </div>
    </div>
