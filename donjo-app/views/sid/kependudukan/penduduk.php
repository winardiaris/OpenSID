    ...
    <div class="ui-layout-north panel">
        <div class="left">
            <div class="uibutton-group">
                <a href="<?php echo site_url('penduduk/form')?>" class="uibutton tipsy south" title="Tambah Data" ><span class="fa fa-plus-circle fa-lg icon-large">&nbsp;</span>Penduduk Pendatang</a>

				<?php  if($grup==1){?><button type="button" title="Hapus Data" onclick="deleteAllBox('mainform','<?php echo site_url("penduduk/delete_all/$p/$o")?>')" class="uibutton chrome"><span class="fa fa-trash-o fa-lg">&nbsp;</span>Hapus Data</button><?php  }?>

                <a href="<?php echo site_url("penduduk/cetak/$o")?>" class="uibutton" title="Cetak Data" target="_blank"><span class="fa fa-print fa-lg">&nbsp;</span>Cetak</a>

				<a href="<?php echo site_url("penduduk/excel/$o")?>" class="uibutton tipsy south" title="Data Excel" target="_blank"><span class="fa fa-file-text fa-lg">&nbsp;</span>Excel</a>

            </div>
        </div>
        <div class="right">
            <div class="uibutton-group">
                <a href="<?php echo site_url("penduduk_log/clear")?>" class="uibutton tipsy south" title="Log Data" ><span class="fa fa-book fa-lg">&nbsp;</span>Log Penduduk</a>
            </div>
        </div>
            <div class="left">
...
<!--
            ...
            <div class="right">
                ...
                <button type="button" onclick="$('#'+'mainform').attr('action','<?php echo site_url('penduduk/search')?>');$('#'+'mainform').submit();" class="uibutton tipsy south"  title="Cari Data"><span class="fa fa-search fa-lg">&nbsp;</span> Cari </button>
            </div>
    </div>
...
<a href="<?php echo site_url("penduduk/detail/$p/$o/$data[id]")?>"  class="uibutton tipsy south"  title="Rincian Data Penduduk"> <span class="fa fa-search-plus fa-lg"> Rincian </span></a>
<a href="<?php echo site_url("penduduk/form/$p/$o/$data[id]")?>"  class="uibutton tipsy south"  title="Ubah Data"> <span  class="fa fa-pencil-square-o fa-lg"></span> </a>


<a href="<?php echo site_url("penduduk/edit_status_dasar/$p/$o/$data[id]")?>" class="uibutton tipsy south" title="Ubah Status Dasar" target="ajax-modal" rel="window" header="Ubah Status Dasar"><i class="fa fa-wrench fa-lg"></i></a>
<a href="<?php echo site_url("penduduk/ajax_penduduk_pindah/$data[id]")?>" class="uibutton tipsy south" title="Pindah Penduduk dalam Desa" target="ajax-modal" rel="window" header="pindah penduduk"><i class="fa fa-share-square-o fa-lg"></i></a>
<?php  if($grup==1){?><a href="<?php echo site_url("penduduk/delete/$p/$o/$data[id]")?>" class="uibutton tipsy south"  title="Hapus Data"  target="confirm" message="Apakah Anda Yakin?" rel="window" header="Hapus Data"><span class="fa fa-trash-o fa-lg"></span></a><?php  }?></div>
</td>
