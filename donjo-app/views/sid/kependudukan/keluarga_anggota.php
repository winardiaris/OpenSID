    ...
    <h3>Daftar Anggota KK No.<?php echo $kepala_kk['no_kk']?> Keluarga : <?php echo unpenetration($kepala_kk['nama'])?></h3>
        <div class="left">
            <div class="uibutton-group">
                ...
                <button type="button" title="Hapus Data" onclick="deleteAllBox('mainform','<?php echo site_url("keluarga/delete_all_anggota/$p/$o/$kk")?>')" class="uibutton tipsy south"><span class="fa fa-trash-o fa-lg">&nbsp;</span>Hapus Data</button>
    ...
    <div class="ui-layout-center" id="maincontent" style="padding: 5px;">
		...
		<tr>
          <td align="center" width="2"><?php echo $data['no']?></td>
           ...
           <td>
 <div class="uibutton-group">
<a href="<?php echo site_url("penduduk/form/$p/$o/$data[id]")?>" class="uibutton tipsy south" title="Ubah Data"><span class="fa fa-pencil-square-o fa-lg"> Ubah </span></a>
