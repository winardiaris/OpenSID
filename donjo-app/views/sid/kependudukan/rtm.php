    ...
    <h3>Manajemen Rumah Tangga</h3>
        <div class="left">
            <div class="uibutton-group">
                ...
                <?php  if($grup==1){?><button type="button" title="Hapus Data" onclick="deleteAllBox('mainform','<?php echo site_url("rtm/delete_all/$p/$o")?>')" class="uibutton tipsy south"><span class="fa fa-trash-o fa-lg">&nbsp;</span>Hapus Data</button><?php  }?>

				<a href="<?php echo site_url("rtm/cetak/$o")?>" target="_blank" class="uibutton tipsy south" title="Print Data" ><span class="fa fa-print fa-lg">&nbsp;</span>Cetak</a>

			<a href="<?php echo site_url("rtm/excel/$o")?>" target="_blank" class="uibutton tipsy south" title="Data Excel" ><span class="fa fa-file-text fa-lg">&nbsp;</span>Excel</a>
                &nbsp;
        ...
        <div class="right">
            <div class="uibutton-group">
                ...
                <button type="button" onclick="$('#'+'mainform').attr('action','<?php echo site_url('rtm/search')?>');$('#'+'mainform').submit();" class="uibutton tipsy south"  title="Cari Data"><span class="fa fa-search fa-lg">&nbsp;</span>Cari</button>
    ...
    <div class="ui-layout-center" id="maincontent" style="padding: 5px;">
		...
		<tr>
          ...
          <td width="5"><div class="uibutton-group">
			<a href="<?php echo site_url("rtm/anggota/$p/$o/$data[id]")?>" class="uibutton tipsy south" title="Rincian Anggota rtm"><span class="fa fa-list fa-lg"> Rincian </span></a>
			<a href="<?php echo site_url("rtm/ajax_add_anggota/$p/$o/$data[id]")?>" target="ajax-modalx" rel="window" header="Tambah Anggota rtm" class="uibutton tipsy south" title="Tambah Anggota rtm"><span  class="fa fa-plus-circle fa-lg-alt  icon-large"></span></a>
        <?php  if($grup==1){?><a href="<?php echo site_url("rtm/delete/$p/$o/$data[id]")?>"  class="uibutton tipsy south"  title="Hapus Data" target="confirm" message="Apakah Anda Yakin?" header="Hapus Data"><span  class="fa fa-trash-o fa-lg"></span> </a><?php  } ?>
		</div> </td>
