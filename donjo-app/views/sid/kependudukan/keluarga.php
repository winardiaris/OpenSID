    ...
    <div class="ui-layout-north panel">
        <div class="left">
            <div class="uibutton-group">
				...
				<a href="<?php echo site_url("keluarga/cetak/$o")?>" target="_blank" class="uibutton tipsy south" title="Print Data" ><span class="fa fa-print fa-lg">&nbsp;</span>Cetak</a>
    ...
    <div class="ui-layout-center" id="maincontent" style="padding: 5px;">
		...
		<tr>
          ...
          <td width="5"><div class="uibutton-group">
            ...
            <a href="<?php echo site_url("keluarga/edit_nokk/$p/$o/$data[id]")?>" class="uibutton tipsy south" title="Ubah Data" target="ajax-modalx" rel="window" header="Ubah Data KK"><span class="fa fa-pencil-square-o fa-lg"></span></a>

			<a href="<?php echo site_url("keluarga/form_a/$p/$o/$data[id]")?>" header="Tambah Anggota Keluarga" class="uibutton tipsy south" title="Tambah Anggota Keluarga"><span  class="fa fa-plus-circle fa-lg-alt  icon-large"></span></a>
