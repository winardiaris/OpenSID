    ...
    <h3>Wilayah Administratif Dusun</h3>
        <div class="left">
            <div class="uibutton-group">
                <a href="<?php echo site_url('sid_core/form')?>" class="uibutton tipsy south" title="Tambah Data" ><i class="fa fa-plus-circle fa-lg">&nbsp;</i>Tambah Dusun</a>
                <a href="<?php echo site_url('sid_core/cetak')?>" target="_blank" class="uibutton tipsy south" title="Print Data" ><span class="fa fa-print fa-lg">&nbsp;</span>Cetak</a>
		<a href="<?php echo site_url('sid_core/excel')?>" target="_blank" class="uibutton tipsy south" title="Data Excel" ><span class="fa fa-file-text fa-lg">&nbsp;</span>Excel</a>
            </div>
        </div>
		<div class="right">
			...
			<button type="button" onclick="$('#'+'mainform').attr('action','<?php echo site_url('sid_core/search')?>');$('#'+'mainform').submit();" class="uibutton tipsy south"  title="Cari Data"><span class="fa fa-search fa-lg">&nbsp;</span>Cari</button>
		</div>
    </div>
...
<a href="<?php echo site_url("sid_core/sub_rw/$data[id]")?>" class="uibutton tipsy south" title="Rincian Sub Wilayah"><span class="fa fa-list fa-lg"> Rincian</span></a>
<a href="<?php echo site_url("sid_core/form/$data[id]")?>" class="uibutton tipsy south" title="Ubah Data"><span  class="fa fa-pencil-square-o fa-lg"></span></a>
