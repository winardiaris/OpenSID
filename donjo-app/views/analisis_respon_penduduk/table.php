    ...
    <div class="ui-layout-center" id="maincontent" style="padding: 5px;">
        <div class="table-panel top">
            ...
            <div class="right">
                ...
                <button type="button" onclick="$('#'+'mainform').attr('action','<?php echo site_url('analisis_respon_penduduk/search')?>');$('#'+'mainform').submit();" class="uibutton tipsy south"  title="Cari Data"><span class="fa fa-search fa-lg">&nbsp;</span>Cari</button>
            </div>
        </div>
        <table class="list">
		<thead>
		...
		<tr>
          ...
          <td><div class="uibutton-group">
            <a href="<?php echo site_url("analisis_respon_penduduk/kuisioner/$p/$o/$data[id]")?>" class="uibutton south"><span class="fa fa-list fa-lg"> Input Data </span></a>
			</div>
          </td>
