				...
				<div id="maincontent" class="ui-layout-center" style="padding:0 3em 0 0;">
					...
					<form id="mainform" name="mainform" action="" method="post">
							<div class="left">
								...
								<button type="button" onclick="$('#'+'mainform').attr('action','<?php echo site_url('data_persil/search')?>');$('#'+'mainform').submit();" class="uibutton tipsy south"  title="Cari Data"><span class="fa fa-search fa-lg">&nbsp;</span>Cari</button>
							</div>
					</form>
			<?php
	...
	if(count($persil)>0){
		...
		foreach($persil as $key=>$item){
			...
			<td><div class=\"uibutton-group\">
					<a class=\"uibutton tipsy south\" href=\"". site_url("data_persil/detail/".$item["id"])."\" title=\"Detail\"><span class=\"fa fa-list fa-lg\"></span> Detail</a>
					...
					<a class=\"uibutton tipsy south\" href=\"". site_url("data_persil/hapus/".$item["id"])."\" title=\"Hapus Data\" target=\"confirm\" message=\"Apakah Anda Yakin?\" header=\"Hapus Data\"><span class=\"fa fa-trash-o fa-lg\"></span></a>
				</div></td>
